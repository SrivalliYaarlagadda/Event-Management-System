...
export default function BrowseEvents() {
  ...
  const [sortBy, setSortBy] = useState<
    null | "date" | "name" | "attendees" | "popularity"
  >(null);
    ...
    <div className="min-h-screen bg-[#F7F9FC] flex">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white p-6 shadow-md h-screen fixed left-0 top-0 z-40">
        ...
        <nav className="space-y-3 mt-6 text-sm">
          <a
            href="/dashboard"
            className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 hover:translate-x-1 transition-all duration-150"
          >
          ...
          <a
            ...
            className="flex items-center gap-3 p-2 bg-blue-50 text-blue-600 rounded-lg shadow-sm"
          >
      ...
      >
        <button
          className="text-2xl mb-6 transition-transform active:scale-90"
      ...
      {/* ================= MAIN CONTENT ================= */}
      <main
        className={`flex-1 md:ml-64 p-4 sm:p-6 lg:p-10 w-full transform transition-all duration-500 ${
      ...
      >
        ...
        <div className="mt-6 space-y-3" ref={filterAreaRef}>
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center flex-1 bg-white px-3 py-3 rounded-lg border border-gray-300 shadow-sm w-full sm:w-auto">
              <input
                ...
                className="w-full outline-none text-sm bg-transparent focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-md transition"
              />
            </div>
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 transition-all duration-150 active:scale-95"
            >
          ...
          {showFilters && (
            <div className="w-full bg-white rounded-xl shadow-lg border border-gray-200 p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 animate-[fadeIn_0.2s_ease-out]">
              {/* Category */}
              <div className="flex flex-col">
                <label className="text-xs text-gray-500 mb-1">Category</label>
                <select
                  className="border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                  value={category}
              ...
              <div className="flex flex-col">
                ...
                <div className="flex gap-2">
                  <input
                    type="date"
                    className="border rounded-md px-2 py-2 text-xs flex-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                    value={fromDate}
              ...
              <div className="sm:col-span-2 lg:col-span-4 flex justify-end gap-3 mt-2">
                <button
                  ...
                  className="text-sm px-4 py-2 rounded-md border transition-all duration-150 hover:bg-gray-50 active:scale-95"
                >
                  Reset
                </button>
                <button
                  ...
                  className="text-sm px-4 py-2 rounded-md bg-blue-600 text-white transition-all duration-150 hover:bg-blue-700 active:scale-95"
                >
                  Apply Filters
                </button>
              </div>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4 text-sm">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className={`px-3 py-1 rounded-md border text-xs transition-all duration-150 active:scale-95 ${
                selectedIds.length
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="inline-flex rounded-md border bg-white overflow-hidden">
              <button
                ...
                className={`px-3 py-1 transition-all duration-150 active:scale-95 ${
                  viewMode === "grid"
            ...
            <select
              ...
              className="border rounded-md px-2 py-1 bg-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {currentPageEvents.map((event) => (
              <div
                ...
                className="group bg-white rounded-xl shadow p-4 flex flex-col cursor-pointer hover:shadow-xl transform transition-all duration-200 hover:-translate-y-1"
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-[10px] font-medium transition-colors duration-150 ${
                ...
                <Image
                  ...
                  height={260}
                  alt={event.title}
                  className="rounded-lg w-full object-contain transition-transform duration-200 group-hover:scale-[1.02]"
                />
            ...
            {currentPageEvents.map((event) => (
              <div
                ...
                className="group bg-white rounded-xl shadow 
                  ...
                  gap-3 sm:gap-4 cursor-pointer 
                  hover:shadow-xl transform transition-all duration-200 hover:-translate-y-1
                  w-full max-w-[350px] sm:max-w-none
                  mx-auto"
              >
                {/* LEFT: image + content (stacked on mobile) */}
                <div className="flex flex-col items-center sm:flex-row sm:items-start gap-4 flex-1 w-full">
                  {/* Image first on small screens */}
                  <div className="order-1 sm:order-1 w-full sm:w-auto flex justify-center">
                    <Image
                      src={event.img}
                      width={140}
                      height={90}
                ...
                {/* RIGHT: Availability (blue line) */}
                <div className="order-3 sm:order-3 w-full sm:w-56">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-3 text-xs sm:text-sm text-gray-600">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`px-3 py-1 rounded-md border transition-all duration-150 active:scale-95 ${
                currentPage === 1
            ...
            {Array.from({ length: totalPages }).map((_, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-8 h-8 rounded-md text-xs transition-all duration-150 active:scale-95 ${
                    currentPage === page
                      ? "bg-blue-600 text-white"
