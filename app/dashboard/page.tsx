...
//       {/* ================= SIDEBAR ================= */}
//       <aside className="hidden md:block w-64 bg-white shadow-md p-6 space-y-6">
...
//           <a href="/dashboard/attendee-insights"
//            className="flex items-center gap-3 text-gray-700 hover:text-black p-2 rounded-lg">
//             <Image src="/atendeeico.png" width={20} height={20} alt="Attendee Insights" />
//             Attendee Insights
//           </a>
...
//               <Image src="/classmanagement.png" width={45} height={45} alt="Events Icon" />
//               <Image src="/12%25.png" width={70} height={70} alt="Growth" />
//             </div>

//             <h3 className="font-semibold mt-4">Total Events</h3>
...
//           <div className="bg-white p-6 rounded-xl shadow">
//             <div className="flex items-center justify-between">
//               <Image src="/traineeinsight.png" width={45} height={45} alt="Bookings Icon" />
//               <Image src="/18%25.png" width={70} height={70} alt="Growth" />
//             </div>

//             <h3 className="font-semibold mt-4">Total Bookings</h3>
...
//           <div className="bg-white p-6 rounded-xl shadow">
//             <div className="flex items-center justify-between">
//               <Image src="/revenueO.png" width={45} height={45} alt="Revenue Icon" />
//               <Image src="/23%25.png" width={70} height={70} alt="Growth" />
//             </div>
...
//           <div className="bg-white p-6 rounded-xl shadow">
//             <div className="flex items-center justify-between">
//               <Image src="/userO.png" width={45} height={45} alt="Attendance Icon" />
//               <Image src="/5%25.png" width={70} height={70} alt="Decrease" />
//             </div>

//             <h3 className="font-semibold mt-4">Avg Attendance</h3>
...
//             <Image src="/bookingtrends.png" width={520} height={300} alt="Booking Trends" className="w-full" />
//           </div>

//           <div className="bg-white p-6 rounded-xl shadow">
//             <h3 className="font-semibold mb-3">Revenue Overview</h3>
//             <Image src="/revenuegraphO.png" width={520} height={300} alt="Revenue Graph" className="w-full" />
//           </div>
//         </div>
...
//               <Image src="/Gtick.png" width={26} height={26} alt="Success" />
//               <div>
//                 <h4 className="font-medium">New Event Registration</h4>
//                 <p className="text-sm text-gray-600 mt-2">
//                   Tech Conference 2024 has 150 new registrations
//                 </p>
//                 <p className="text-xs text-gray-500 mt-4">2 hours ago</p>
//               </div>
//             </div>
//           </div>

//           {/* Item 2 */}
//           <div className="relative bg-orange-50 p-6 rounded-lg">
//             <div className="flex items-start gap-3">
//               <Image src="/lowerror.png" width={26} height={26} alt="Warning" />
//               <div>
//                 <h4 className="font-medium">Low Ticket Availability</h4>
//                 <p className="text-sm text-gray-600 mt-2">
//                   Summer Music Festival has only 20 tickets left
//                 </p>
//                 <p className="text-xs text-gray-500 mt-4">5 hours ago</p>
//               </div>
//             </div>
//           </div>
...
//             <div className="flex items-start gap-3">
//               <Image src="/blueerror.png" width={26} height={26} alt="Info" />
//               <div>
//                 <h4 className="font-medium">Event Starting Soon</h4>
//                 <p className="text-sm text-gray-600 mt-2">
//                   Marketing Workshop begins in 2 days
//                 </p>
//                 <p className="text-xs text-gray-500 mt-4">1 day ago</p>
//               </div>
//             </div>
//           </div>
...
//     cells.push({ day: d, event: eventDays.includes(d) });
...
//               >
//                 <Image src="/notification.png" width={26} height={26} alt="" />
...
//           {/* Search + Notification + Profile in ONE ROW */}
...
//             <p className="text-xs text-gray-text-gray-400 mt-4">Highlighted dates have events.</p>
//           </div>
//         </div>
...
//no dropdowns working n no click backs the dropdown
// "use client";
...
//           {/* ------------------------------------ */}
//           {/* Notification + Profile (YOUR CODE)   */}
//           {/* ------------------------------------ */}

//           <div className="flex items-center gap-4">

//             {/* NOTIFICATION */}
//             <div className="relative noti-area" ref={notifyRef}>
//               <button
//                 className="relative bg-white p-3 rounded-full shadow-sm"
//                 onClick={(e) => {
//                   e.stopPropagation();
            ...
            <div className="relative" ref={notifyRef}>
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-lg p-4 text-sm z-50">
                  ...
                  {/* <div className="mb-3 bg-green-50 rounded-xl p-3 flex gap-3">
                    <Image src="/Gtick.png" width={14} height={14} alt="" />
                    <div>
                      <p className="text-xs font-semibold">New Event Registration</p>
